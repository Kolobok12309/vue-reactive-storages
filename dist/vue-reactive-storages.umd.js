(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["vue-reactive-storages"] = factory();
	else
		root["vue-reactive-storages"] = factory();
...
var from = __webpack_require__("adf3");
...
var dP = __webpack_require__("3adc").f;
var create = __webpack_require__("7108");
var redefineAll = __webpack_require__("3904");
var ctx = __webpack_require__("bc25");
var anInstance = __webpack_require__("b0bc");
var forOf = __webpack_require__("560b");
var $iterDefine = __webpack_require__("e4a9");
var step = __webpack_require__("245b");
var setSpecies = __webpack_require__("1be4");
var DESCRIPTORS = __webpack_require__("7d95");
var fastKey = __webpack_require__("6277").fastKey;
var validate = __webpack_require__("1fca");
...
var bind = __webpack_require__("1ea0");
var rConstruct = (__webpack_require__("da3c").Reflect || {}).construct;
...
module.exports = __webpack_require__("b347");
...
$export($export.P + $export.R, 'Map', { toJSON: __webpack_require__("034c")('Map') });
...
module.exports = __webpack_require__("f4bb");
...
__webpack_require__("93c4");
__webpack_require__("b42c");
__webpack_require__("edb9");
__webpack_require__("8747");
__webpack_require__("8a77");
__webpack_require__("261e");
module.exports = __webpack_require__("a7d3").Map;
...
var speciesConstructor = __webpack_require__("02d7");
...
var toObject = __webpack_require__("0185");
var toLength = __webpack_require__("a5ab");
var asc = __webpack_require__("bf06");
...
var strong = __webpack_require__("0780");
var validate = __webpack_require__("1fca");
var MAP = 'Map';

// 23.1 Map Objects
module.exports = __webpack_require__("f2f6")(MAP, function (get) {
...
var global = __webpack_require__("da3c");
var $export = __webpack_require__("d13f");
var meta = __webpack_require__("6277");
var fails = __webpack_require__("d782");
var hide = __webpack_require__("8ce0");
var redefineAll = __webpack_require__("3904");
var forOf = __webpack_require__("560b");
...
var setToStringTag = __webpack_require__("c0d8");
var dP = __webpack_require__("3adc").f;
var each = __webpack_require__("eb46")(0);
var DESCRIPTORS = __webpack_require__("7d95");
...
module.exports = __webpack_require__("a7d3").Reflect.construct;
...
function (_Error) {
  ...
  function StorageError(message) {
    ...
    message = "[ReactiveStorage] ".concat(message);
    _this = _possibleConstructorReturn(this, getPrototypeOf_getPrototypeOf(StorageError).call(this, message));
...
function getStoreByType(type) {
  switch (type) {
    ...
    default:
      new mainClass_StorageError('Wrong storage type');
      return window.localStorage;
  }
...
function setEItem(key, value) {
  ...
  switch (typeof_typeof(value)) {
    ...
    case 'function':
      ...
      throw new mainClass_StorageError('Function can\'t be in storage');
...
/*#__PURE__*/
function () {
  function _ReactiveStorage(preset) {
  ...
  _createClass(_ReactiveStorage, [{
    ...
    value: function _initConfig() {
      ...
      window.addEventListener('storage', function (_ref) {
        ...
        if (_this2._$store === storageArea && key === _this2._$config.name) {
          Object.assign(_this2, store.getJSONItem(_this2._$config.name));
        }
      });
...
// CONCATENATED MODULE: ./src/vuexModule.ts
/* harmony default export */ var vuexModule = (function (reactiveStorage) {
  return {
    state: reactiveStorage,
    mutations: {
      saveReactiveStorage: function saveReactiveStorage() {
        reactiveStorage.saveStorage(true);
      }
    },
    getters: {
      getReactiveStorage: function getReactiveStorage() {
...
function injectProp(Vue, app, propName, storage) {
  ...
  if (tools_hasOwnProperty(app, key) || tools_hasOwnProperty(Vue.prototype, key)) {
  ...
  Vue.use(function () {
    Vue.mixin({
      data: function data() {
        return _defineProperty({}, key, storage);
      }
    });
...
function makeReactiveProp(app, propName, storage) {
  ...
  if (tools_hasOwnProperty(app.watch, key)) throw new Error('[ReactiveStorage] propName is already used in watchers');
  app.watch[key] = {
...
//# sourceMappingURL=vue-reactive-storages.umd.js.map